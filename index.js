...
const max_redirect_chain_depth = process.env.MAX_REDIRECT_CHAIN_DEPTH || 100;
...
if (!process.env.AMAZON_TLD) {
  console.log("Missing AMAZON_TLD env variable, using the default one (.it)");
  amazon_tld = "it";
} else {
